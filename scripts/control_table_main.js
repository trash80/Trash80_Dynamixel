...
function createGettersAndSetters()
{
    ...
    for (var key in protocol_properties) {
        ...
        getter += 'virtual uint'+sizes[protocol_sizes[key]]+'_t get'+f+'() { return 0; };'+"\n";
        setter += 'virtual bool set'+f+'(uint'+sizes[protocol_sizes[key]]+'_t value) { return false; };'+"\n";
    }
